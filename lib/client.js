...
Client.prototype.connect = function(callback) {
  ...
  var isMD5 = function (string) {
    return string.startsWith('md5') && string.length === 35;
  }

  //password request handling
  con.on('authenticationMD5Password', checkPgPass(function(msg) {
    var inner = isMD5(self.password) ? self.password.slice(3) : Client.md5(self.password + self.user);
